...
public final class GdxGraphicsImpl implements FFGraphics {
    ...
    public final void renderShape( final ShapeData data ) {
        ...
        DynArrayRO<RGBColor> colors = data.getColors();
    ...
    @Override
    public final void flush( DynArrayRO<View> virtualViews ) {
    ...
    private void getShapeColor( final DynArrayRO<RGBColor> colors, int index, final Color color ) {
